...
public class AdoDapper : IAdo
{
    ...
    public void AltaCasa (Casa casa)
    {
        ...
        Conexion.Execute("altaCasa", parametros); // Carga el sp y los parametros.
    ...
    public void AltaElectrodomestico (Electrodomestico electrodomestico)
    {
        ...
        parametros.Add("unNroHabitaciones", electrodomestico.NroHabitaciones);
    ...
    {
        var parametros = new DynamicParameters();
        parametros.Add("@unidHistorialRegistro", direction: ParameterDirection.Output);
        ...
        Conexion.Execute("altaHistorialRegistro", parametros);
    ...
    public void AltaConsumo (Consumo consumo)
    {
        ...
        parametros.Add("@unidElectrododmestico", consumo.IdElectrodomestico);
